<x-app-layout>
    <div class=" space-y-8" x-data="{ link: null }">
        <div class="py-5 border-b px-3 md:px-10 flex space-x-5 items-center">
            ...
            <span class="text-xs">Setup theme for your organization</span>
        </div>
            ...
            <ul class=" flex flex-col md:flex-row gap-6">
                ...
                <a href="{{ route('settings.theme') }}">
                    <li @click="link = 'QR'"
                        ...
                        <i class='bx bx-cookie text-xl mr-2'></i>Theme
                    </li>
                </a>
            </ul>
        </div>
        ...
        <section>
            <div class="relative overflow-x-auto shadow sm:rounded-lg w-full md:w-[90%] mx-auto space-y-5 pb-5">
                @if ($errors->any())
                ...
                <form action="{{ route('settings.updateTheme', ['id' => $site->id]) }}" method="post"
                    enctype="multipart/form-data" class="px-6 space-y-5 divide-y w-full md:w-[70%] mx-auto">
                    @csrf
                    @method('PUT')
                    <div class="py-4">
                    ...
                    <div class="py-4">
                        ...
                        <div class="border-2 rounded-lg  pb-2 m-0 bg-gray-50 flex space-x-2 w-full items-center mt-3">
                        ...
                        <label for="" class="font-semibold text-sm text-cyan-700">Page background color</label>
                        <div class="border-2 rounded-lg  pb-2 m-0 bg-gray-50 flex space-x-2 w-full items-center mt-3">
                    ...
                    <div class="py-4">
                        ...
                        <select name="font" id="font" class="form-control mt-3">
                            <option value="Arial, sans-serif" @if ($site->font == 'Arial, sans-serif') selected @endif>Arial
                            </option>
                            <option value="Helvetica, sans-serif" @if ($site->font == 'Helvetica, sans-serif') selected @endif>
                                Helvetica</option>
                            <option value="Times New Roman, serif" @if ($site->font == 'Times New Roman, serif') selected @endif>
                                Times New Roman</option>
                            <option value="Georgia, serif" @if ($site->font == 'Georgia, serif') selected @endif>Georgia
                            </option>
                            <option value="Courier New, monospace" @if ($site->font == 'Courier New, monospace') selected @endif>
                                Courier New</option>
                            <option value="Verdana, sans-serif" @if ($site->font == 'Verdana, sans-serif') selected @endif>
                                Verdana</option>
                            <option value="Impact, sans-serif" @if ($site->font == 'Impact, sans-serif') selected @endif>Impact
                            </option>
                            <option value="Trebuchet MS, sans-serif" @if ($site->font == 'Trebuchet MS, sans-serif') selected @endif>
                                Trebuchet MS</option>
                            ...
                            <option value="Comic Sans MS, cursive" @if ($site->font == 'Comic Sans MS, cursive') selected @endif>
