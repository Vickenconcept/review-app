                ...
                <div class=" h-full w- lg:flex-1 px-3 min-h-0 min-w-0 ">
                    ...
                    <div class="bg-gray-200 w-full h-full min-h-0 min-w-0 overflow-auto p-4 space-y-10 ">
                        ...
                        <form class="flex gap-4   flex-col md:flex-row">
                            <div class="relative  block w-full">
                                ...
                                <input type="text" id="term" wire:model="search_key"
                                    ...
                                    placeholder="unique identifier eg: XE7514EB99116CA91B437017DF7324FAF">
                            </div>
                        ...
                        <div class="text-xs bg-blue-100 text-gray-700 p-3 rounded-md font-semibold">
                            A textual identifier that uniquely identifies a place in Trustedshops. This identifier can be taken from the url of the software in Trustedshops. For example, if the url for the place in Trustedshops is  
                             <span class="text-red-500">
                                https://www.trustedshops.de/bewertung/info_XE7514EB99116CA91B437017DF7324FAF.html
                            </span>
                             the identifier is XE7514EB99116CA91B437017DF7324FAF
